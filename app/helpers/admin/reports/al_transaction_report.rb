module Admin::Reports::AlTransactionReport
  include ViewsHelper
  ...
  def csv_header(options)
    header = ["Created At", "Purchase Date", "Sales Office Code", "Sales Group Code", "Dealer Hierarchy", "Sap Code", "Part Number", "Quantity", "Points Per Unit", "Total Points"]
  end
